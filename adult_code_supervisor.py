...
start = time.time()
wine_clf = basicResults(pipeA,wine_trnX,wine_trnY,wine_tstX,wine_tstY,params_wine,'ANN','wine')        
end = time.time()
end-start
...
pipeA.set_params(**{'MLP__early_stopping':False})                  
makeTimingCurve(wineX,wineY,pipeA,'ANN','wine')
pipeA.set_params(**wine_final_params)
pipeA.set_params(**{'MLP__early_stopping':False})                  
iterationLC(pipeA,wine_trnX,wine_trnY,wine_tstX,wine_tstY,{'MLP__max_iter':[2**x for x in range(12)]+[2100,2200,2300,2400,2500,2600,2700,2800,2900]},'ANN','wine')                
pipeA.set_params(**wine_OF_params)
pipeA.set_params(**{'MLP__early_stopping':False})               
iterationLC(pipeA,wine_trnX,wine_trnY,wine_tstX,wine_tstY,{'MLP__max_iter':[2**x for x in range(12)]+[2100,2200,2300,2400,2500,2600,2700,2800,2900]},'ANN_OF','wine')                
